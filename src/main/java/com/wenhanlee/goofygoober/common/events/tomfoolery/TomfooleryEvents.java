...
import com.wenhanlee.goofygoober.common.capabilities.tomfoolery.cooldowncounter.TomfooleryCooldownCounter;
import com.wenhanlee.goofygoober.common.capabilities.tomfoolery.cooldowncounter.TomfooleryCooldownCounterProvider;
import com.wenhanlee.goofygoober.common.capabilities.tomfoolery.scallywag.TomfooleryScallywag;
import com.wenhanlee.goofygoober.common.capabilities.tomfoolery.scallywag.TomfooleryScallywagProvider;
...
public class TomfooleryEvents {
    ...
    public static void onAttachCapabilitiesEventScallywag(AttachCapabilitiesEvent<Entity> event) {
        ...
        if (event.getObject() instanceof Mob mob && !event.getObject().getCommandSenderWorld().isClientSide()) {
