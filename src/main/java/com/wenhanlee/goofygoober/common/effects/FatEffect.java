...
//        System.out.println(pLivingEntity.getDisplayName().getString() + " has gained the fat effect");
...
//        System.out.println(pLivingEntity.getDisplayName().getString() + " has lost the fat effect");
        PacketDistributor.TRACKING_ENTITY.with(() -> pLivingEntity).send(
